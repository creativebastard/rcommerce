// R Commerce API Client
// Handles all communication with the R Commerce backend
...
const api = {
    ...
    async getCart() {
        ...
        const response = await this.authenticatedFetch(`${API_BASE_URL}/carts`);
    ...
    async addToCart(productId, quantity = 1) {
        ...
        const response = await this.authenticatedFetch(`${API_BASE_URL}/carts/items`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    async updateCartItem(itemId, quantity) {
        ...
        const response = await this.authenticatedFetch(`${API_BASE_URL}/carts/items/${itemId}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
    ...
    async getOrder(orderId) {
        const response = await this.authenticatedFetch(`${API_BASE_URL}/orders/${orderId}`);
    ...
    async createPayment(orderId, paymentMethod) {
        const response = await this.authenticatedFetch(`${API_BASE_URL}/payments`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ 
                order_id: orderId, 
